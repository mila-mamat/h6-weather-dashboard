...
function renderTodaysWeather() {
    ...
    let todaysWeatherURL = "http://api.openweathermap.org/data/2.5/weather?q=" + cityToForecast + "&units=imperial&appid=ac5b144a5d66349f6a02d23d24193989";
    fetch(todaysWeatherURL)
        ...
        .then(function (response) {
            ...
            document.querySelector("#current-weather-icon").src = "http://openweathermap.org/img/wn/" + iconNumber + "@2x.png"
            ...
            let UVindexURL = "http://api.openweathermap.org/data/2.5/uvi?lat=" + cityLat + "&lon=" + cityLon + "&appid=ac5b144a5d66349f6a02d23d24193989";
...
function renderForecastedWeather() {
    ...
    let weatherForecastURL = "http://api.openweathermap.org/data/2.5/forecast?q=" + cityToForecast + "&units=imperial&appid=ac5b144a5d66349f6a02d23d24193989";
    fetch(weatherForecastURL)
        ...
        .then(function (response) {
            ...
            forecastCards.forEach(function (card) {
                ...
                card.children[1].src = "http://openweathermap.org/img/wn/" + iconNumber + "@2x.png"
